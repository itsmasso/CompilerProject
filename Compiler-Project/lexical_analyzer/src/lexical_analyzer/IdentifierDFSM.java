...
public class IdentifierDFSM {
	...
	*/
	public enum StateHandler{
		//We used enums because enums allow for more readable/cleaner code and best when you need a list of predefined constants.
		Q1(false), Q2(true), Q3(true), Q4(true), Q5(true), Q6(false); //Initializing states and whether they are accepting or not. 
		
		StateHandler letter;
		StateHandler digit;
		StateHandler underScore;
		
		private final boolean isAccepted; //this variable is constant as we declare whether the states are accepting or not before hand
